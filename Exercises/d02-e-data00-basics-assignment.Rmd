...
seems odd that you could have a real object with only two dimensions (how are there diamonds with 0 x,y,or z dimensions)
its odd that cut is worst to best but color is best to worst on the list
